...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "account_overview_title":  {"mm": "အကောင့်လက်ကျန် Overview", "en": "Account Balance Overview"},
    "account_overview_search_ph": {"mm": "အကောင့်အမည်၊ ဖုန်း၊ ID ဖြင့်ရှာပါ", "en": "Search account name, phone, or ID"},
    "account_overview_summary": {"mm": "{count} ခု | စုစုပေါင်း {total} MMK", "en": "{count} accounts | Total {total} MMK"},

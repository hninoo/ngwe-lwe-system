...
echo   Builds: NgweLweSystem-Setup-v1.0.1.exe   (client)
echo           NgweLweServer-Setup-v1.0.1.exe   (server manager)
echo ============================================================
echo.
...
echo ============================================================
echo.
echo   installer\NgweLweSystem-Setup-v1.0.1.exe   (Client / Host)
echo   installer\NgweLweServer-Setup-v1.0.1.exe   (Server Manager)
echo.
